...
DataCard GenerateDummyData() {
  DataCard dc = DataCard(
      ...
      startDate: DateTime(2020, 05, 29),
      endDate: DateTime(2020, 12, 20));
  final ds1 = DataSeries(
    name: "Views",
    plotType: PlotType.Line,
    items: [
      DataItem(timestamp: DateTime(2020, 05, 29), value: 98),
      DataItem(timestamp: DateTime(2020, 06, 4), value: 101),
      DataItem(timestamp: DateTime(2020, 06, 13), value: 1688),
      DataItem(timestamp: DateTime(2020, 06, 19), value: 600),
      DataItem(timestamp: DateTime(2020, 06, 26), value: 804),
      DataItem(timestamp: DateTime(2020, 07, 3), value: 185),
      DataItem(timestamp: DateTime(2020, 07, 5), value: 195),
      DataItem(timestamp: DateTime(2020, 07, 9), value: 532),
      DataItem(timestamp: DateTime(2020, 07, 16), value: 81),
      DataItem(timestamp: DateTime(2020, 07, 24), value: 73),
      DataItem(timestamp: DateTime(2020, 07, 27), value: 169),
      DataItem(timestamp: DateTime(2020, 07, 29), value: 60),
      DataItem(timestamp: DateTime(2020, 07, 31), value: 182),
      DataItem(timestamp: DateTime(2020, 07, 31), value: 484),
      DataItem(timestamp: DateTime(2020, 08, 7), value: 1088),
      DataItem(timestamp: DateTime(2020, 08, 14), value: 501),
      DataItem(timestamp: DateTime(2020, 08, 21), value: 341),
      DataItem(timestamp: DateTime(2020, 08, 29), value: 232),
      DataItem(timestamp: DateTime(2020, 09, 1), value: 378),
      DataItem(timestamp: DateTime(2020, 09, 5), value: 249),
      DataItem(timestamp: DateTime(2020, 09, 9), value: 728),
      DataItem(timestamp: DateTime(2020, 09, 16), value: 337),
      DataItem(timestamp: DateTime(2020, 09, 23), value: 275),
      DataItem(timestamp: DateTime(2020, 10, 7), value: 234),
      DataItem(timestamp: DateTime(2020, 10, 14), value: 371),
      DataItem(timestamp: DateTime(2020, 10, 22), value: 256),
      DataItem(timestamp: DateTime(2020, 10, 31), value: 202),
      DataItem(timestamp: DateTime(2020, 11, 21), value: 218),
      DataItem(timestamp: DateTime(2020, 11, 28), value: 190),
      DataItem(timestamp: DateTime(2020, 12, 5), value: 192),
      DataItem(timestamp: DateTime(2020, 12, 13), value: 253),
      DataItem(timestamp: DateTime(2020, 12, 20), value: 318),
    ],
  );
...
DataCard GenerateWorldEvents() {
  ...
  worldEvents.forEach((e) {
    ...
    final d1 = DataItem(timestamp: convertToDate(e["timeFrom"]!), value: 98);
    ds.items.add(d1);
    final d2 = DataItem(timestamp: convertToDate(e["timeTo"]!), value: 98);
    ds.items.add(d2);
