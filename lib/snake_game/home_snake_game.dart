...
class HomeSnakeGame extends StatefulWidget {
  const HomeSnakeGame({Key? key}) : super(key: key);

  @override
  _HomeSnakeGameState createState() => _HomeSnakeGameState();
}

class _HomeSnakeGameState extends State<HomeSnakeGame> {
  ...
  void startGame() {
    ...
    print("Snake first: ${snake.first}");
    print("Snake first[0]: ${snake.first[0]}");
    print("Snake first[1]: ${snake.first[1]}");
